<template>
  <div class="form-field">
    ...
    <textarea
      ...
      rows="6"
      class="w-full px-3 py-2 text-sm font-mono border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 resize-y"
      :class="[
        error 
          ? 'border-red-500 dark:border-red-500 bg-red-50 dark:bg-red-900/20' 
          : 'border-gray-300 dark:border-gray-600 bg-gray-900 text-green-400'
      ]"
      spellcheck="false"
    ></textarea>
